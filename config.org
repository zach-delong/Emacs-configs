...
***** Keybindings for "other modes"

      Evil itself has a set of keybindings for lots of modes, but not all of them make sense to me. Instead, I want to use [[*Evil-collection][evil-collection]] to set up a bunch of defaults that I can manipulate as I see fit.

      To make sure that I don't conflict with ~evil-collection~ I need to make sure Evil doesn't try to load those default keybindings.
...
**** Evil-surround
     ...
     Want to surround strings or expressions with things? [[https://github.com/emacs-evil/evil-surround][This]] is how!
...
*** TODO dired
    ...
    #+BEGIN_SRC emacs-lisp
      (use-package dired
	:custom
	; I don't like having dotfiles in my output, so I have them hidden here. 
