...
***** File manipulation hotkeys
	...
	(evil-global-set-key 'normal (kbd "<leader> f f") 'find-file)
      ...
      I also frequently use dired to jump around my file system, especially when I don't know what I am looking for.
      #+BEGIN_SRC emacs-lisp :tangle no
	(evil-global-set-key 'normal (kbd "<leader> f d") 'dired)
      #+END_SRC
