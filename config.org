...
**** Require package
	...
	(evil-define-key 'normal org-mode-map (kbd "SPC m s l") 'org-promote-subtree)
	(evil-define-key 'normal org-mode-map (kbd "SPC m s h") 'org-demote-subtree)
...
*** TODO Markdown-mode
	...
	:ensure t
	:config
	(evil-define-key 'normal markdown-mode-map (kbd "SPC m d") 'markdown-do)
	...
	(evil-define-key 'normal markdown-mode-map (kbd "SPC m s l") 'markdown-promote)
	(evil-define-key 'normal markdown-mode-map (kbd "SPC m s h") 'markdown-demote))
    #+END_SRC
*** Python mode
