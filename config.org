...
***** Leader
      ...
      #+BEGIN_SRC emacs-lisp :tangle no
	(evil-set-leader '(motion normal visual replace operator emacs) (kbd "SPC"))
	(evil-set-leader '(motion normal visual replace operator emacs) (kbd "<leader> m") t)
      #+END_SRC
...
*** LSP-mode
    ...
    #+END_SRC
*** Solarized theme
   I have used variants of Solarized themes for years. [[https://github.com/bbatsov/solarized-emacs][This one seems pretty reputable for Emacs]].
    #+BEGIN_SRC emacs-lisp :tangle config.el
