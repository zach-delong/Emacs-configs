...
**** Require package
	...
	(evil-define-key 'normal org-mode-map (kbd "<leader> m d s") 'org-schedule)
	(evil-define-key 'normal org-mode-map (kbd "<leader> m d d") 'org-deadline)

	(evil-define-key 'normal org-mode-map (kbd "<leader> m s r") 'org-refile)
	(evil-define-key 'normal org-mode-map (kbd "<leader> m s n") 'org-narrow-to-subtree)
	(evil-define-key 'normal org-mode-map (kbd "<leader> m s a") 'org-archive-subtree-default)
	(evil-define-key 'normal org-mode-map (kbd "<leader> m s w") 'widen)
	(evil-define-key 'normal org-mode-map (kbd "<leader> m s h") 'org-promote)
	(evil-define-key 'normal org-mode-map (kbd "<leader> m s l") 'org-demote)

	(evil-define-key 'normal org-mode-map (kbd "<leader> m p") 'org-priority)

	(evil-define-key 'normal org-mode-map (kbd "<leader> m C i") 'org-clock-in)
	(evil-define-key 'normal org-mode-map (kbd "<leader> m C o") 'org-clock-out)

	(evil-define-key 'normal org-mode-map (kbd "<leader> m T T") 'org-todo)
	(evil-define-key 'normal org-mode-map (kbd "<leader> m b t") 'org-babel-tangle)

	(evil-define-key 'normal org-mode-map (kbd "<leader> m i l") 'org-insert-link)
	(evil-define-key 'normal org-mode-map (kbd "<leader> m i i") 'org-insert-item)
	(evil-define-key 'normal org-mode-map (kbd "<leader> m i t") 'org-set-tags-command)
	(evil-define-key 'normal org-mode-map (kbd "<leader> m i T t") 'org-table-create)
	(evil-define-key 'normal org-mode-map (kbd "<leader> m i T r") 'org-table-insert-row)
	(evil-define-key 'normal org-mode-map (kbd "<leader> m i T c") 'org-table-insert-column)
	(evil-define-key 'normal org-mode-map (kbd "<leader> m i s") 'org-insert-src-block)

	(evil-define-key 'normal org-mode-map (kbd "<leader> m <return>") 'org-open-at-point)
...
#+BEGIN_SRC emacs-lisp
  (use-package org-pomodoro
    ...
    :after org
    :config
    (evil-define-key 'normal org-mode-map (kbd "<leader> m C p") 'org-pomodoro)
...
*** Web mode
	...
	(evil-define-key 'normal web-mode-map (kbd "<leader> m <tab>") 'web-mode-fold-or-unfold)
	(evil-define-key 'normal web-mode-map (kbd "<leader> m i l") 'web-mode-file-link)
	(evil-define-key 'normal web-mode-map (kbd "<leader> m g t") 'web-mode-navigate)
	(evil-define-key 'normal web-mode-map (kbd "<leader> m g j") 'web-mode-tag-next)
	(evil-define-key 'normal web-mode-map (kbd "<leader> m g k") 'web-mode-tag-previous))
    #+END_SRC
*** Zettelkasten
...
*** Markdown-mode
	...
	:ensure t
	:config
	(evil-define-key 'normal markdown-mode-map (kbd "<leader> m <return>") 'markdown-do)
	(evil-define-key 'normal markdown-mode-map (kbd "<leader> m g f") 'markdown-outline-next-same-level)
	(evil-define-key 'normal markdown-mode-map (kbd "<leader> m g b") 'markdown-outline-previous-same-level)
	(evil-define-key 'normal markdown-mode-map (kbd "<leader> m g n") 'markdown-outline-next)
	(evil-define-key 'normal markdown-mode-map (kbd "<leader> m g p") 'markdown-outline-previous)
	(evil-define-key 'normal markdown-mode-map (kbd "<leader> m g u") 'markdown-outline-up)

	(evil-define-key 'normal markdown-mode-map (kbd "<leader> m i f") 'markdown-insert-footnote)
	(evil-define-key 'normal markdown-mode-map (kbd "<leader> m i w") 'markdown-insert-wiki-link)
	(evil-define-key 'normal markdown-mode-map (kbd "<leader> m i i") 'markdown-insert-image)
	(evil-define-key 'normal markdown-mode-map (kbd "<leader> m i l") 'markdown-insert-link)
	(evil-define-key 'normal markdown-mode-map (kbd "<leader> m i H") 'markdown-insert-hr)
	(evil-define-key 'normal markdown-mode-map (kbd "<leader> m i h 1") 'markdown-insert-header-atx-1)
	(evil-define-key 'normal markdown-mode-map (kbd "<leader> m i h 2") 'markdown-insert-header-atx-2)
	(evil-define-key 'normal markdown-mode-map (kbd "<leader> m i h 3") 'markdown-insert-header-atx-3)
	(evil-define-key 'normal markdown-mode-map (kbd "<leader> m i t t") 'markdown-insert-table)
	(evil-define-key 'normal markdown-mode-map (kbd "<leader> m i t r") 'markdown-table-insert-row)
	(evil-define-key 'normal markdown-mode-map (kbd "<leader> m i t c") 'markdown-table-insert-column)

	(evil-define-key 'normal markdown-mode-map (kbd "<leader> m s h") 'markdown-promote)
	(evil-define-key 'normal markdown-mode-map (kbd "<leader> m s l") 'markdown-demote)
	(evil-define-key 'normal markdown-mode-map (kbd "<leader> m S h") 'markdown-toggle-markup-hiding)

	(evil-define-key 'normal markdown-mode-map (kbd "<leader> m p") 'markdown-live-preview-mode)

	(evil-define-key 'normal markdown-mode-map (kbd "<leader> m e e") 'markdown-export)
	(evil-define-key 'normal markdown-mode-map (kbd "<leader> m e p") 'markdown-export-and-preview)
...
*** TODO Typescript mode
	...
	:ensure t
	:config
	(evil-define-key 'normal tide-mode-map (kbd "<leader> m g d") 'tide-jump-to-definition)
	(evil-define-key 'normal tide-mode-map (kbd "<leader> m r .") 'tide-refactor)
	(evil-define-key 'normal tide-mode-map (kbd "<leader> m r r") 'tide-rename-symbol)
	:hook
...
*** LSP-mode
	...
	:ensure t
	:init
	(evil-define-key 'normal lsp-mode-map (kbd "<leader> m") lsp-command-map)
	:hook
	((csharp-mode . lsp)
