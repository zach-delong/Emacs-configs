...
**** Evil itself
	 ...
	 (evil-global-set-key 'normal (kbd "SPC <tab>") 'previous-buffer)
	 (evil-global-set-key 'normal (kbd "SPC <S-tab>") 'next-buffer) ; this works on Windows
	 (evil-global-set-key 'normal (kbd "SPC <backtab>") 'next-buffer) ; this works on Linux
	 (evil-global-set-key 'normal (kbd "SPC f s") 'save-buffer)
	 (evil-global-set-key 'normal (kbd "SPC f S") 'evil-write-all)
	 (evil-global-set-key 'normal (kbd "SPC f y") 'evil-yank-file-name)
	 (evil-global-set-key 'normal (kbd "SPC l l") 'eval-last-sexp)
	 (evil-global-set-key 'normal (kbd "SPC l L") 'eval-print-last-sexp)
	 (evil-global-set-key 'normal (kbd "SPC l b") 'eval-buffer)
	 (evil-global-set-key 'normal (kbd "SPC l r") 'eval-region)
	 ...
	 (evil-global-set-key 'normal (kbd "SPC w H") 'evil-window-move-far-left)
	 (evil-global-set-key 'normal (kbd "SPC w J") 'evil-window-move-far-down)
	 (evil-global-set-key 'normal (kbd "SPC w K") 'evil-window-move-far-up)
	 (evil-global-set-key 'normal (kbd "SPC w L") 'evil-window-move-far-right)
	 (evil-global-set-key 'normal (kbd "SPC w s") 'evil-window-split)
	 (evil-global-set-key 'normal (kbd "SPC w v") 'evil-window-vsplit)
	 (evil-global-set-key 'normal (kbd "SPC w d") 'evil-window-delete)
	 (evil-global-set-key 'normal (kbd "SPC w o") 'other-window)
	 (evil-global-set-key 'normal (kbd "SPC w m") 'delete-other-windows)
	 (evil-global-set-key 'normal (kbd "SPC w f") 'make-frame)
	 (evil-global-set-key 'normal (kbd "SPC b d") 'kill-buffer)
	 (evil-global-set-key 'normal (kbd "SPC b s") 'switch-to-scratch)
	 (evil-global-set-key 'normal (kbd "SPC q f") 'save-buffers-kill-terminal)
	 (evil-global-set-key 'normal (kbd "SPC h f") 'describe-function)
	 (evil-global-set-key 'normal (kbd "SPC h v") 'describe-variable)
	 (evil-global-set-key 'normal (kbd "SPC h k") 'describe-key)
	 (evil-global-set-key 'normal (kbd "SPC h n") 'view-emacs-news)
	 (evil-global-set-key 'normal (kbd "SPC h m") 'describe-mode)
	 (evil-global-set-key 'normal (kbd "SPC h i") 'info)
	 (evil-global-set-key 'normal (kbd "SPC h M") 'view-order-manuals)
	 )
     #+END_SRC
...
I borrowed this from a blog post
...
**** Require package
	...
	(evil-define-key 'normal org-mode-map (kbd "SPC m i s") 'org-insert-src-block)
...
#+BEGIN_SRC emacs-lisp
  (use-package org-pomodoro
    ...
    :after org
    :config
    (evil-define-key 'normal org-mode-map (kbd "SPC m C p") 'org-pomodoro)
...
#+BEGIN_SRC emacs-lisp
  (use-package flyspell
    ...
    :config
    (evil-global-set-key 'normal (kbd "SPC s c") 'flyspell-correct-word-before-point)
    (evil-global-set-key 'normal (kbd "SPC s b") 'flyspell-buffer))
#+END_SRC
